...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/repo-header.gif">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/iterm2.png">
</p>
...
##### Clone the Repo
    ...
    $ git clone https://github.com/crazydan/dev-setup.git && cd dev-setup
...
**For more customization, you can [clone](#clone-the-repo) or [fork](https://github.com/crazydan/dev-setup/fork) the repo and tweak the `.dots` script and its associated components to suit your needs.**
...
#### Running without Git
    ...
    $ curl -O https://raw.githubusercontent.com/crazydan/dev-setup/feature/customize-for-crazydan/.dots && ./.dots [Add ARGS Here]

#### Scripts

* [.dots](https://github.com/crazydan/dev-setup/blob/master/.dots)
    * Runs specified scripts
* [bootstrap.sh](https://github.com/crazydan/dev-setup/blob/master/bootstrap.sh)
    * Syncs dev-setup to your local home directory `~`
* [osxprep.sh](https://github.com/crazydan/dev-setup/blob/master/osxprep.sh)
    * Updates OS X and installs Xcode command line tools
* [brew.sh](https://github.com/crazydan/dev-setup/blob/master/brew.sh)
    * Installs common Homebrew formulae and apps
* [osx.sh](https://github.com/crazydan/dev-setup/blob/master/osx.sh)
    * Sets up OS X defaults geared towards developers
* [pydata.sh](https://github.com/crazydan/dev-setup/blob/master/pydata.sh)
    * Sets up python for data analysis
* [aws.sh](https://github.com/crazydan/dev-setup/blob/master/aws.sh)
    * Sets up Spark, Hadoop MapReduce, and Amazon Web Services
* [datastores.sh](https://github.com/crazydan/dev-setup/blob/master/datastores.sh)
    * Sets up common data stores
* [web.sh](https://github.com/crazydan/dev-setup/blob/master/web.sh)
    * Sets up JavaScript web development
* [android.sh](https://github.com/crazydan/dev-setup/blob/master/android.sh)
    * Sets up Android development
...
I encourage you to read through Section 1 so you have a better idea of what each installation script does.  The following discussions describe in greater detail what is executed when running the [.dots](https://github.com/crazydan/dev-setup/blob/master/.dots) script.

### bootstrap.sh script

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/commands.png">
  <br/>
</p>
...
To sync dev-setup to your local home directory without Git, run the following:
    ...
    $ cd ~; curl -#L https://github.com/crazydan/dev-setup/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh,LICENSE}
...
You could also use `~/.extra` to override settings, functions, and aliases from the dev-setup repository, although it’s probably better to [fork the dev-setup repository](https://github.com/crazydan/dev-setup/fork).

### osxprep.sh script

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/xcode.jpg">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/homebrew2.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/osx.png">
  <br/>
</p>
...
**Note**: **I strongly encourage you read through the commented [osx.sh source file](https://github.com/crazydan/dev-setup/blob/master/osx.sh) and tweak any settings based on your personal preferences.  The script defaults are intended for you to customize.**  For example, if you are not running an SSD you might want to change some of the settings listed in the SSD section.
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/pydata.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/aws.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/datastores.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/webdev.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/android.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/sublime.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/atom.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/terminal.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/vim.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/virtualbox.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/vagrant.jpeg">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/docker.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/git.png">
  <br/>
</p>
...
Let's set up some basic configuration. Download the [.gitconfig](https://raw.githubusercontent.com/crazydan/dev-setup/feature/customize-for-crazydan/.gitconfig) file to your home directory:

    $ cd ~
    $ curl -O https://raw.githubusercontent.com/crazydan/dev-setup/feature/customize-for-crazydan/.gitconfig
...
**Note**: On a Mac, it is important to remember to add `.DS_Store` (a hidden OS X system file that's put in folders) to your `.gitignore` files. You can take a look at this repository's [.gitignore](https://github.com/crazydan/dev-setup/blob/master/.gitignore) file for inspiration.  Also check out GitHub's [collection of .gitignore templates](https://github.com/github/gitignore).

### Homebrew

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/homebrew.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/ruby.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/python.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/anaconda.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/data-science-ipython-notebooks/master/images/README_1200x800.gif">
</p>
...
* [data-science-ipython-notebooks](https://github.com/crazydan/data-science-ipython-notebooks)
* [interactive-coding-challenges](https://github.com/crazydan/interactive-coding-challenges)

### NumPy

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/numpy.png">
  <br/>
</p>
...
Refer to the following [Numpy IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#numpy).

### Pandas

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/pandas.png">
  <br/>
</p>
...
Refer to the following [pandas IPython Notebooks](https://github.com/crazydan/data-science-ipython-notebooks#pandas).

### Matplotlib

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/matplotlib.png">
  <br/>
</p>
...
Refer to the following [matplotlib IPython Notebooks](https://github.com/crazydan/data-science-ipython-notebooks#matplotlib).

### Seaborn

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/seaborn.png">
  <br/>
</p>
...
Refer to the following [matplotlib with Seaborn IPython Notebooks](https://github.com/crazydan/data-science-ipython-notebooks#matplotlib).

### Scikit-learn

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/scikitlearn.png">
  <br/>
</p>
...
Refer to the following [scikit-learn IPython Notebooks](https://github.com/crazydan/data-science-ipython-notebooks#scikit-learn).

### SciPy

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/scipy.png">
  <br/>
</p>
...
Refer to the following [SciPy IPython Notebooks](https://github.com/crazydan/data-science-ipython-notebooks#statistical-inference-scipy).

### Flask

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/flask.png">
  <br/>
</p>
...
[Coming Soon] Refer to the following [Flask IPython Notebooks](https://github.com/crazydan/data-science-ipython-notebooks#).

### Bokeh

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/bokeh.png">
  <br/>
</p>
...
[Coming Soon] Refer to the following [Bokeh IPython Notebooks](https://github.com/crazydan/data-science-ipython-notebooks#).
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/spark.png">
  <br/>
</p>
...
Refer to the following [Spark IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#spark).
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/mrjob.png">
  <br/>
</p>
...
Refer to the following [mrjob IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#mapreduce-python).
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/data-science-ipython-notebooks/master/images/aws.png">
</p>
<br/>

[Awesome AWS](https://github.com/crazydan/awesome-aws) is a curated list of awesome AWS libraries, open source repos, guides, blogs, and other resources.  It's a great way to stay up-to-date with the various aws-backed and community-led efforts geared towards AWS.
...
*Repos not on `The Fiery Meter of AWSome` can still be awesome, see [A Note on Repo AWSomeness](https://github.com/crazydan/awesome-aws/blob/master/CONTRIBUTING.md#a-note-on-repo-awsomeness).*
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/aws_cli.png">
  <br/>
</p>
...
Refer to the following [AWS CLI IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#aws).
...
Refer to the [repo link](https://github.com/crazydan/saws).

### Boto

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/boto.png">
  <br/>
</p>
...
Refer to the following [Boto IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#aws).

### S3cmd

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/s3cmd.png">
  <br/>
</p>
...
Refer to the following [s3cmd IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#aws).

### S3DistCp

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/s3distcp.png">
  <br/>
</p>
...
Refer to the following [S3DistCp IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#aws).

### S3-parallel-put

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/s3-parallel-put.png">
  <br/>
</p>
...
Refer to the following [s3-parallel-put IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#aws).

### Redshift

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/aws_redshift.png">
  <br/>
</p>
...
Refer to the following [Redshift IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#aws).

### Kinesis

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/aws_kinesis.png">
  <br/>
</p>
...
Refer to the following [Kinesis IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#aws).

### Lambda

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/aws_lambda.png">
  <br/>
</p>
...
Refer to the following [Lambda IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#aws).

### AWS Machine Learning

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/aws_ml.png">
  <br/>
</p>
...
[Coming Soon] Refer to the following [AWS Machine Learning IPython Notebook](https://github.com/crazydan/data-science-ipython-notebooks#aws).

### Heroku

<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/heroku.jpg">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/mysql.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/mysql_workbench.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/mongodb.jpeg">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/redis.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/elasticsearch.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/nodejs.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/jshint.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/less.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/java.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/androidsdk.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/androidstudio.png">
  <br/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/crazydan/dev-setup-resources/master/res/intellij.png">
  <br/>
</p>
...
Bug reports, suggestions, and pull requests are [welcome](https://github.com/crazydan/dev-setup/issues)!

### Credits

See the [Credits Page](https://github.com/crazydan/dev-setup/blob/master/CREDITS.md).

## Contact Info

Feel free to contact me to discuss any issues, questions, or comments.

My contact info can be found on my [GitHub page](https://github.com/crazydan).
